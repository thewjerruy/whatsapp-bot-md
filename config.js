...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '923465125306').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Ｑ Ｕ Ｅ Ｅ Ｎ✦α и α у α ✦,
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG |true | '_Antilink Detected &mention kicked_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG |true | '_Antispam Detected &mention kicked_',
  ...
  KOYEB_NAME: (process.env.KOYEB_NAME || 'Ｑ Ｕ Ｅ Ｅ Ｎ✦α и α у α ✦').trim(),
